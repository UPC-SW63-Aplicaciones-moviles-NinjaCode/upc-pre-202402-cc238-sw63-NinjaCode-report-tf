...
| Datos del paciente: | Entrevista |
|---|---|
|  <p>Nombres:   </p> <p>Apellidos:</p> <p> Edad: </p> <p> Localidad:  </p> <p> Timing:  </p> <p> Duración:  </p> <p style="max-width: 350px;"> Link: </p>| <img src="" width=400> |
| Resumen:<p> </p> | 
