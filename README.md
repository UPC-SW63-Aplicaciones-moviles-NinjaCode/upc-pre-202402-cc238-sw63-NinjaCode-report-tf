...
| Jherson David Astuyauri Calderon          | Desarrollar la primera versión de la app móvil con frontend conectado al backend. | 24/08/2024      | 24/10/2024                       | Implementar la primera versión de la aplicación móvil en Flutter, asegurando la conexión entre el frontend y el backend. | Tener una versión funcional de la app con la interfaz de usuario y las APIs del backend integradas y operativas. | Desarrollar e integrar las capas frontend y backend en 2 meses. | Este objetivo es esencial para probar la funcionalidad básica de la app y avanzar hacia el lanzamiento del MVP. | La primera versión debe estar lista en 2 meses. 
| Estefano Sebastian Lostaunau Pereira          | Desarrollar una aplicación móvil que simplifique las acciones de los usuarios, asegurando que el uso de la app sea sencillo y eficiente. | 25/08/2024      | 24/10/2024                       | Implementar una aplicación móvil que simplifique las acciones de los usuarios, mejorando la experiencia de uso y eficiencia en la navegación. | Sí, la meta es reducir el tiempo promedio de navegación de los usuarios en un 30% y aumentar la tasa de finalización de tareas en un 20%. | Sí, este objetivo requiere un enfoque en el diseño centrado en el usuario y la implementación de nuevas funcionalidades que mejoren la usabilidad, lo cual implica un esfuerzo significativo y una estrategia bien definida. | Sí, este objetivo está alineado con la estrategia de NinjaCode de mejorar la experiencia del usuario y aumentar la adopción de la aplicación entre los pacientes con enfermedades hormonales. | La aplicación debe estar lista y operativa para en 2 meses. | 
